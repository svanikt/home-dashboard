...
function getHousePositions(center, halfSize) {
  ...
  return {
    // House numbers - small, positioned near center line intersections
    houseNumbers: {
      // 1st house: At top of center diamond
      1: { x: center, y: center - halfSize * 0.15 },

      // 2nd house: Upper left, on diagonal line
      2: { x: center - halfSize * 0.18, y: center - halfSize * 0.25 },

      // 3rd house: Left upper, on diagonal line
      3: { x: center - halfSize * 0.25, y: center - halfSize * 0.18 },

      // 4th house: Left of center
      4: { x: center - halfSize * 0.25, y: center + 5 },

      // 5th house: Left lower, on diagonal line
      5: { x: center - halfSize * 0.25, y: center + halfSize * 0.18 },

      // 6th house: Lower left, on diagonal line
      6: { x: center - halfSize * 0.18, y: center + halfSize * 0.25 },

      // 7th house: At bottom of center diamond
      7: { x: center, y: center + halfSize * 0.28 },

      // 8th house: Lower right, on diagonal line
      8: { x: center + halfSize * 0.18, y: center + halfSize * 0.25 },

      // 9th house: Right lower, on diagonal line
      9: { x: center + halfSize * 0.25, y: center + halfSize * 0.18 },

      // 10th house: Right of center
      10: { x: center + halfSize * 0.25, y: center + 5 },

      // 11th house: Right upper, on diagonal line
      11: { x: center + halfSize * 0.25, y: center - halfSize * 0.18 },

      // 12th house: Upper right, on diagonal line
      12: { x: center + halfSize * 0.18, y: center - halfSize * 0.25 }
    },
